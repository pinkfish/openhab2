 ...
 */
package org.openhab.binding.elkalarm.internal;

import static org.openhab.binding.elkalarm.ElkAlarmBindingConstants.*;

import java.util.Collections;
import java.util.Set;

import org.openhab.binding.elkalarm.handler.ElkAlarmHandler;
...
public class ElkAlarmHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(THING_TYPE_SAMPLE)) {
            return new ElkAlarmHandler(thing);
        }
